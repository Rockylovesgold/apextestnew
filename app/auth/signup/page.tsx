    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-8" style={{ background: 'var(--color-bg-base)' }}>
      ...
      <div className="w-full max-w-md relative">
        <div className="text-center mb-8">
          ...
          <p style={{ color: 'var(--color-text-secondary)' }}>Join the AIOV Capital trading community</p>
        </div>
        ...
        <div className="card" style={{ padding: '2rem' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              style={{ background: 'var(--color-accent-gold)', color: 'var(--color-text-inverse)', boxShadow: '0 4px 16px rgba(54,128,255,0.25)' }}>
